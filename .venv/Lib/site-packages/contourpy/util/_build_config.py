...
def build_config() -> dict[str, str]:
    ...
    return dict(
        ...
        python_path=r"C:/Users/runneradmin/AppData/Local/Temp/build-env-016uwye1/Scripts/python.exe",
        ...
        # Misc meson settings
        meson_backend="ninja",
        build_dir=r"C:/a/contourpy/contourpy/.mesonpy-llpwl71v/lib/contourpy/util",
        source_dir=r"C:/a/contourpy/contourpy/lib/contourpy/util",
        cross_build="False",

        # Build options
        build_options=r"-Dbuildtype=release -Db_ndebug=if-release -Db_vscrt=md -Dvsenv=True '--native-file=C:/a/contourpy/contourpy/.mesonpy-llpwl71v/meson-python-native-file.ini'",
        buildtype="release",
        cpp_std="c++17",
        debug="False",
        optimization="3",
